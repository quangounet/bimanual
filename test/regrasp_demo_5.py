...
if __name__ == "__main__":
  ...
  T_right_robot = np.array(
    [[ 0.9999599223, -0.0040494323,  0.0071425583, -0.0010716475],
     ...
     [ 0.          ,  0.          ,  0.          ,  1.          ]])
  T_frame = np.array(
    [[ 0.0552682025, -0.9936813581, -0.0976871757,  0.5523434877],
     [ 0.9984665182,  0.0553132225,  0.0022493393,  0.054105591 ],
     [ 0.003168266 , -0.0976616912,  0.9952146282,  0.1850904077],
     [ 0.          ,  0.          ,  0.          ,  1.          ]])
