...
if __name__ == "__main__":
  ...
  T_frame = np.array(
   [[ 0.0141874819, -0.1104851349,  0.9937765092, -0.3449324965],
    ...
    [-0.0771195148, -0.9910369453, -0.1090795746,  0.4160543382],
    [ 0.          ,  0.          ,  0.          ,  1.          ]])
  ...
  T_obj_goal = np.array(
   [[ 0.0038325298,  0.1402944345, -0.9901024105,  0.5020188093],
    [-0.9972415754,  0.0739288701,  0.0066153268, -0.142555654 ],
    [ 0.074125246 ,  0.9873459342,  0.1401907774,  0.0618671477],
    [ 0.          ,  0.          ,  0.          ,  1.          ]])
  ...
  q_robots_goal = utils.compute_bimanual_goal_configs(
                    [left_robot, right_robot], frame, q_robots_start,
                     q_robots_grasp, T_obj_start, T_obj_goal,seeds=[1,1])
