...
class ClosedChainMotion(object):
  def __init__(self):
    ...
    q_right_start = right_manip.FindIKSolutions(T_right_gripper, orpy.IkFilterOptions.CheckEnvCollisions)[1]
    ...
    res = ccplanner.solve(timeout=150)

    ccquery.serialize()
    with open('precious3_s_rp.pkl', 'wb') as f:
    ...
    manip_utils.execute_ccregrasptraj_compliance(
