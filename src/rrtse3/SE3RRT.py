...
class RRTPlanner():
    ...
    def ExtendFW(self, c_rand):
        ...
        for index in nnindices:
            ...
            trajectorytranstring = SE3Utils.TrajString3rdDegree(qt_beg, qt_end, 
                                                                qts_beg, qts_end, 
    ...
    def ExtendBW(self, c_rand):
        ...
        for index in nnindices:
            ...
            if (not self.IsFeasibleConfig(c_new)):
                if self.PRINT:
                    print '[ExtandBW] TRAPPED (infeasible configuration)'
                STATUS = TRAPPED
                continue            
            ...
            if (result[0] == OK):
                ...
                if self.PRINT:
                    print '[ExtandBW] TRAPPED (trajectory in collision)'
                STATUS = TRAPPED
        return STATUS
    ...
    def Run(self, allottedtime):
        ...
        if self.PRINT:
            print "\033[1;31mAllotted time (", allottedtime, " sec.) is exhausted after", 
            self.iterations - prev_it, "iterations.", "\033[0m"
        return False
